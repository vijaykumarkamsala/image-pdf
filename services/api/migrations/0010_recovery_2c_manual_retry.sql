...
BEGIN
  ...
  IF OLD.state IN ('ready', 'rejected', 'expired', 'cancelled')
     AND NOT guest_retention_expiry AND NOT terminal_cleanup_update AND NOT manual_retry THEN
...
INSERT INTO schema_migrations(version) VALUES ('0010_recovery_2c_manual_retry');
COMMIT;
